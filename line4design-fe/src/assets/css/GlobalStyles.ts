...
const GlobalStyle = createGlobalStyle`
  @font-face {
    ...
    font-weight: 400;
    src:
      url(${require('../fonts/Spartan-SemiBold.woff')}) format("woff");
  }
  @font-face {
    font-family: Spartan-regular;
    font-weight: 400;
    src:
      url(${require('../fonts/Spartan-Regular.woff')}) format("woff");
  }
  @font-face {
    font-family: Spartan-medium;
    font-weight: 500;
    src:
      url(${require('../fonts/Spartan-Medium.woff')}) format("woff");
  }
  @font-face {
    ...
    font-size: 14px;
    src:
      url(${require('../fonts/Spartan-Bold.woff')}) format("woff");
  }
  @font-face {
    font-family: Roboto;
    font-weight: 400;
